...
const WURLInput = URLInput as unknown as React.FC<URLInput.Props>;

export default function Edit({ attributes, setAttributes }: BlockEditProps<BlockProps>) {
  const { slides, showArrows, arrowSVG, showDots, progressColor, slideWidthDesktop, slideWidthMobile, slideHeight, overlay, dotSVG, dotActiveSVG } = attributes;
